...
namespace MyCAD
{
    ...
    {
        //string lConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["SQLiteConnection"].ConnectionString;
        //string lPath = System.IO.Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
        //string lFullPath = System.IO.Path.Combine(lPath, lConnectionString);
        //string lConnectionParams = ConfigurationManager.AppSettings["SQLiteParams"];
