    ...
    public partial class Input_Values : Form
    {
        ...
        private void DataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                //string message = $"Row {e.RowIndex} selected.\n";
                ...
                //    {
                //        //message += $"{dataGridView1.Columns[cell.ColumnIndex].HeaderText}: {cell.Value}\n";
                //        idTextBox.Text = cell.Value.ToString();
                //        materialTextBox.Text = cell.Value.ToString();
                //        tensileStrengthTextBox.Text = cell.Value.ToString();

                //    }
                //    MessageBox.Show(message, "Row Selected", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }   
